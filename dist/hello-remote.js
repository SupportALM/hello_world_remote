...
function Wt() {
  ...
  function pe(n, i, g) {
    ...
    if (n && n.defaultProps)
      for (b in T = n.defaultProps, T)
        C[b] === void 0 && (C[b] = T[b]);
    return { $$typeof: X, type: n, key: k, ref: O, props: C, _owner: K.current };
  }
  function we(n, i) {
  ...
  function G(n, i, g, b, C) {
    ...
    if (O)
      return O = n, C = C(O), n = b === "" ? "." + z(O, 0) : b, ue(C) ? (g = "", n != null && (g = n.replace(Te, "$&/") + "/"), G(C, i, g, "", function(W) {
        return W;
    ...
    if (O = 0, b = b === "" ? "." : b + ":", ue(n))
      ...
      for (n = w.call(n), T = 0; !(k = n.next()).done; )
        k = k.value, w = b + z(k, T++), O += G(k, i, g, w, C);
    else if (k === "object")
  ...
  return m.Children = { map: U, forEach: function(n, i, g) {
    ...
    if (i != null) {
      if (i.ref !== void 0 && (k = i.ref, O = K.current), i.key !== void 0 && (C = "" + i.key), n.type && n.type.defaultProps)
    ...
    return { $$typeof: X, type: n.type, key: C, ref: k, props: b, _owner: O };
    ...
    process.env.NODE_ENV !== "production" && function() {
      ...
      function Ee(e, r, a, o, c) {
        ...
        if (f) {
          ...
          if ($e(E)) {
            var j = "";
            P != null && (j = ye(P) + "/"), Ee(E, r, j, "", function(Mt) {
              return Mt;
            });
          } else
        ...
        if ($e(e))
          ...
          if (typeof Nr == "function") {
            ...
            for (var $t = Nr.call(ft), lt, Lt = 0; !(lt = $t.next()).done; )
              A = lt.value, I = B + xe(A, Lt++), N += Ee(A, r, a, I, c);
          } else if (d === "object") {
            var dt = String(e);
...
Check the top-level render call using <` + a + ">.");
      ...
      v.Children = Ft, v.Component = b, v.Fragment = te, v.Profiler = Z, v.PureComponent = w, v.StrictMode = ne, v.Suspense = V, v.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = U, v.act = ct, v.cloneElement = Dt, v.createContext = sr, v.createElement = xt, v.createFactory = It, v.createRef = gr, v.forwardRef = jr, v.isValidElement = be, v.lazy = kr, v.memo = u, v.startTransition = jt, v.unstable_act = ct, v.useCallback = F, v.useContext = p, v.useDebugValue = he, v.useDeferredValue = Ke, v.useEffect = h, v.useId = Ar, v.useImperativeHandle = Re, v.useInsertionEffect = Y, v.useLayoutEffect = D, v.useMemo = J, v.useReducer = S, v.useRef = _, v.useState = R, v.useSyncExternalStore = xr, v.useTransition = q, v.version = Ce, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
...
function Vt() {
  if (yt)
    return Ge;
  yt = 1;
  var X = mt, v = Symbol.for("react.element"), Ce = Symbol.for("react.fragment"), Q = Object.prototype.hasOwnProperty, de = X.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, te = { key: !0, ref: !0, __self: !0, __source: !0 };
  function ne(Z, $, ee) {
    ...
    function Sr(t, u, s, p, R) {
      {
        ...
        s !== void 0 && (Be(s), h = "" + s), Rr(u) && (Be(u.key), h = "" + u.key), Er(u) && (Y = u.ref, Cr(u, R));
        for (S in u)
        ...
        return wr(t, h, Y, R, p, _e.current, _);
      }
    }
    ...
    function cr(t, u, s, p, R, S) {
      {
        ...
        if (ge.call(u, "key")) {
          var he = z(t), q = Object.keys(u).filter(function(xr) {
            return xr !== "key";
...
var Yt = Vr.exports;
function Bt() {
  return /* @__PURE__ */ Yt.jsx("div", { style: { fontSize: 24, padding: 20 }, children: "Hello World from Bundled Remote Tool!" });
}
export {
  Bt as default
};
