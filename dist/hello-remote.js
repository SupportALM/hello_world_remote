...
function cr() {
  return Se || (Se = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function Ie(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === m || e === I || Ae || e === A || e === T || e === p || Fe || e === W || xe || ke || De || typeof e == "object" && e !== null && (e.$$typeof === R || e.$$typeof === b || e.$$typeof === P || e.$$typeof === h || e.$$typeof === c || // This needs to include all possible module reference object
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, X, _, sr, _), me[_ + X] = !0;
          }
        }
...
var dr = Z.exports;
function pr() {
  return /* @__PURE__ */ dr.jsx("div", { style: { padding: 20, fontSize: 24, color: "#2d72d9" }, children: "Hello World from Remote Vite Tool!" });
}
export {
  pr as default
};
